...
public class main_jframe extends zehntausend {
    public static void main(String[] args) {
        ...
        // button_nextPlayer.setBackground();
        ...
        // --------------Button - costom
        button_custom.setBounds(840 + button_abstand, 0, 175, 410);
        button_custom.setText("Costom");
        // button_3mal6.setBackground();
        button_custom.addActionListener(e -> {
            costom(player[playerpick.getPlayer()], 5000);
